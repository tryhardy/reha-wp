...
<head>
	...
	<?//скрипты и стили шаблона?>
	<?wp_head();?>

	<?//свои стили?>
	<?wp_enqueue_style( "main", get_template_directory_uri().'/main.min.css', array(), filemtime(get_template_directory().'/main.min.css'), false);?>

	<?//свои скрипты?>
	<?wp_enqueue_script( 'script-name', get_template_directory_uri().'/js/main.min.js', array(), '1.0.0', true );?>
